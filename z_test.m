...
for bias = bias_begin : bias_step :bias_end
    ...
    for loop = amp_loop_begin : amp_loop_step :amp_loop_end
        ...
        load_path = save_path + "/data/10M/amp"+loop+"/bias"+bias+"/mat";
...
%% Save data
savePath_txt = save_path + "/result3/"+t.Month+"."+t.Day+"/mix_bias_amp/Threenonlinear"+ver+"/net/looptime"+ver+"/net"+ver;   
savePath_mat = save_path + "/result3/"+t.Month+"."+t.Day+"/mix_bias_amp/Threenonlinear"+ver+"/net/looptime"+ver+"/net"+ver;   
