...
savePath_txt = save_path + "/result3/"+t.Month+"."+t.Day+"/trainedNet/v"+ver+"/amp"+amp+"/v"+net_ver;
savePath_mat = save_path + "/result3/"+t.Month+"."+t.Day+"/trainedNet/v"+ver+"/amp"+amp+"/v"+net_ver;
